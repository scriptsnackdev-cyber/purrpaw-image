...
const LOADING_STEPS = [
  ...
  "Translating portraits to high-fidelity Chibi landmarks...",
  "Applying pop-anime style shaders...",
  "Rendering bold pop-style outlined texts...",
  "Positioning red-fill text overlays...",
  "Polishing sticker outlines & visual gloss...",
  "Formatting generated base64 buffer...",
];

export default function ChibiTalkPage() {
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("/api/generate-chibi-talk", {
        method: "POST",
      ...
      console.error("Chibi Talk generation failed:", err);
      setErrorMsg(err.message || "Failed to generate chibi sticker.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDownload = () => {
    ...
    link.download = `chibi-talk-${Date.now()}.png`;
    ...
    <>
      ...
      <div className="app-container">
        ...
        <div className="hero-section">
          <span className="hero-mini-tag">CHIBI STICKER WITH TEXT OUTLINES</span>
          <h1 className="hero-title">
            Chibi <span className="hero-title-highlight">Talk</span> Dialogue
          </h1>
          <p className="hero-subtitle">
            Recreate character portraits as super cute Japanese chibi anime stickers, stamped with bold white-stroked text.
          </p>
        </div>
          ...
          <form className="panel-card" onSubmit={handleGenerate}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
              ...
              <div>
                ...
                <input
                  ...
                  className="prompt-textarea"
                  style={{ minHeight: "auto", height: "42px", padding: "0.5rem 0.75rem", marginTop: "0.4rem" }}
                  placeholder="E.g., Birthday, Space..."
                  value={theme}
            ...
            <div>
              ...
              <div className="textarea-wrapper" style={{ marginTop: "0.5rem" }}>
                <textarea
                  className="prompt-textarea"
                  placeholder="Dialogue inside the sticker (e.g. Omg! No way!, Happy Birthday!). This will be drawn in red with thick white outlines."
                  value={talkText}
              ...
              {!loading && resultImage && (
                <div className="results-wrapper">
                  <div className="results-header">
                    <h3 className="results-title">✨ Chibi Sticker Dialogue</h3>
